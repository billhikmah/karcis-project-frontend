  ...
  return (
    <div className="profile_right-side col-sm-6 col-md-8 col-lg-9">
      ...
      <Modal
        ...
        title={booking[eventIndex].event_id.name}
        navigateHandler={navigateHandler}
        whitePath="close"
        whiteButton="close"
        bluePath={booking[eventIndex].event_id.id}
        ...
        message={
          <div className="myBooking__modal-container">
            <div className="myBooking__modal-message">
              ...
              <div>: {booking[eventIndex].event_id.location.name}</div>
            </div>
            <div className="myBooking__modal-message">
              <div className="myBooking__modal-key">Date</div>
              <div>: {booking[eventIndex].event_id.date_time_show}</div>
            </div>
            <div className="myBooking__modal-message">
              <div className="myBooking__modal-key">Total Ticket</div>
              <div>: {booking[eventIndex].total_ticket}</div>
            </div>
            <div className="myBooking__modal-message">
              <div className="myBooking__modal-key">Total Payment</div>
              <div>: {booking[eventIndex].total_payment}</div>
            </div>
            <div className="myBooking__modal-message">
